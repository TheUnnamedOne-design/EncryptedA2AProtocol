...
class HelperAgent:
    ...
    def __init__(self, my_address="https://localhost:5001"):
    ...
    def fetch_peer_certificate(self, peer_address):
        ...
        Args:
            peer_address: Base URL of peer agent (e.g., "https://127.0.0.1:5002")
    ...
    def send_communication_request(self, peer_address, peer_agent_id):
        ...
        Args:
            peer_address: HTTPS address of peer (e.g., "https://localhost:5002")
